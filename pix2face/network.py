...
class Unet(nn.Module):
    def __init__(self, num_filters, channels_in=3, channels_out=3):
        ...
        self.norm2_dn = nn.InstanceNorm2d(num_filters * 2)
        self.norm4_dn = nn.InstanceNorm2d(num_filters * 4)
        self.norm8_dn1 = nn.InstanceNorm2d(num_filters * 8)
        self.norm8_dn2 = nn.InstanceNorm2d(num_filters * 8)
        self.norm8_dn3 = nn.InstanceNorm2d(num_filters * 8)
        self.norm8_dn4 = nn.InstanceNorm2d(num_filters * 8)
        self.norm8_up1 = nn.InstanceNorm2d(num_filters * 8)
        self.norm8_up2 = nn.InstanceNorm2d(num_filters * 8)
        self.norm8_up3 = nn.InstanceNorm2d(num_filters * 8)
        self.norm8_up4 = nn.InstanceNorm2d(num_filters * 8)
        self.norm4_up = nn.InstanceNorm2d(num_filters * 4)
        self.norm2_up = nn.InstanceNorm2d(num_filters * 2)
        self.norm1_up = nn.InstanceNorm2d(num_filters)
